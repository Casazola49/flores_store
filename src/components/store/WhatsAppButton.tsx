...
export default function WhatsAppButton() {
  ...
  return (
    <button
      ...
      aria-label={totalItems > 0 ? "Ver carrito y completar pedido" : "Contactar por WhatsApp"}
    >
      {/* Badge con cantidad */}
      {totalItems > 0 && (
        <span className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-[#9B1C1C] text-white text-[10px] font-black rounded-full flex items-center justify-center shadow-md">
